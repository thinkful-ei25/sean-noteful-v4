...
const { folders, users, notes } = require('../db/data');
...
describe.only('Noteful API - Folders', function () {
  ...
  before(() => {
    return mongoose
      .connect(TEST_MONGODB_URI, { useNewUrlParser: true, useCreateIndex : true })
  ...
  describe('PUT /api/folders/:id', () => {
    ...
    it('should update the folder', function () {
      const updateItem = { name: 'New Folder' };
      let data;
